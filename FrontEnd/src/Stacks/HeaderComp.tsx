...
import HeaderProp from "../Stacks/HeaderProp"
    ...
    <div className="w-full h-[100vh] flex justify-center items-center">
      ...
      >
        ...
        <div className="w-[25%] flex justify-between items-center">
           <div className="flex justify-center items-center bg-[#F1F5F9]">
           ...
           >
            <IoMdEyeOff className="text-[#1AAAEA]"/>
                <p className="font-[600] ml-[4px]">Preview</p>
            </button>
